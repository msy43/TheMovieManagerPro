...
class FavoriteMovieAdapter @Inject constructor(var glide: RequestManager) :
    ...
    var movieList: List<FavoriteMovie>
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MovieViewHolder {
        val view =
            LayoutInflater.from(parent.context)
                .inflate(R.layout.movie_item_desing_three, parent, false)
