...
class WatchListMovieAdapter @Inject constructor(var glide: RequestManager) :
    RecyclerView.Adapter<WatchListMovieAdapter.MovieViewHolder>() {

    class MovieViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView)

    private var onItemClickListener: ((WatchListMovie) -> Unit)? = null


    private var diffUtil =

        object : DiffUtil.ItemCallback<WatchListMovie>() {
    ...
    var movieList: List<WatchListMovie>
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MovieViewHolder {
        val view =
            LayoutInflater.from(parent.context)
                .inflate(R.layout.movie_item_desing_two, parent, false)
    ...
    fun setOnItemClickListener(listener: (WatchListMovie) -> Unit) {
    ...
    override fun onBindViewHolder(holder: MovieViewHolder, position: Int) {
        ...
        holder.itemView.apply {
            ...
            date.text = setDate(movieList[position].release_date)
